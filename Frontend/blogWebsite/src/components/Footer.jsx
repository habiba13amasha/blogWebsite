...
export default function Footer() {
  return (
    <>
      <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10 flex flex-col lg:flex-row justify-between ">
        <aside >
        <svg 
    ...
    >
      ...
      />
          ...
          <p>
            Welcome to our blog!
            <br />
            Explore insightful articles, tips, and stories on tech, lifestyle,
            and self-growth.
            <br />
            New content every week to keep you informed and inspired.
          </p>
        </aside>
        <nav>
